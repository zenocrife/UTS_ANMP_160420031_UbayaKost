...
class DetailKostFragment : Fragment() {
    ...
    fun observeViewModel() { //function cek model.kt
        ...
        viewModel.kostLD.observe(viewLifecycleOwner, Observer {
            ...
            txtGenderDetail.setText(arrKost[0].gender)
            txtRegionDetail.setText(arrKost[0].region)
            txtAlamatDetail.setText(arrKost[0].alamat)
            txtFasilitasDetail.setText(arrKost[0].fasilitas)
            txtRatingDetail.setText(arrKost[0].rating)
